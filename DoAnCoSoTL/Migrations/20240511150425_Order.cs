        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ListSeat = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MovieId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_Cinemas_CinemaId",
                        column: x => x.CinemaId,
                        principalTable: "Cinemas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderDetails_Movies_MovieId1",
                        column: x => x.MovieId1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_CinemaId",
                table: "OrderDetails",
                column: "CinemaId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_MovieId1",
                table: "OrderDetails",
                column: "MovieId1");
